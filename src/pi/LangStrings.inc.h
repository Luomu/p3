...
DECLARE_STRING(INCREASE_SPEED)
DECLARE_STRING(DECREASE_SPEED)
DECLARE_STRING(THRUST_FORWARD)
DECLARE_STRING(THRUST_REVERSE)
DECLARE_STRING(THRUST_LEFT)
DECLARE_STRING(THRUST_RIGHT)
DECLARE_STRING(OVERRIDE_AUTO_VELOCITY)
DECLARE_STRING(FIRE_PRIMARY)
